window.onmousemove=function(e){
    ...
    document.querySelector(".myLogo").style.transform=`translate(${-50 - (newNum*10)}%,${-50 - (newNum2*10)}%)`
    }
...
$(".ico-next").click(function(){
   ...
   current=(current+1+$(".slider-item").lenth)%$(".slider-item").length
   $(".slider-item").removeClas(".sld-active")
   $(".slider-item").eq(current).addClass("sld-active")
   $(".slider-item")
})
